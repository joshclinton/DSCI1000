...
```{r}
dtm.tfidf <- bind_tf_idf(dtm, word, document, n) # use special function to bind the information
...
*SELF_TEST:* Can you use `castHamilton` to summarize the 4 main topics that Hamilton wrote about?  How many papers are in each cluster?  What is the primary themes of each?  
