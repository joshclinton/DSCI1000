---
title: "Text And Prediction, Part 3"
author: "Josh Clinton"
date: "`r Sys.Date()`"
output: pdf_document
...
But raw word counts are not reliable predictors because some authors may be more verbose than others. Let's consider the relationship between authorship and document length.  Start by creating a tibble `worddoc` with 2 variables that combines the authorship with the total number words being used in each.  
