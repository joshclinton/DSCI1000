---
title: "Topic 7: Mapping in R (One way)"
author: "Josh Clinton"
date: "`r Sys.Date()`"
output: pdf_document
---
...
```{r}
PollDat <- readRDS(file="PresStatePolls04to20.Rds") %>%
...
```{r eval=FALSE}
covidvote <- readRDS(file="COVID.Death.Voting.Rds") 
covidvote <- covidvote %>%
...
```{r}
countycovid <- readRDS(file="countycovid.Rds")
```
